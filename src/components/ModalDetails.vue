<template>
  <div id="modalDetails" class="escolha__modal">
      ...
      <div class="escolha__modal__modal-content">
          ...
          <p id="detailsCheckin">Check in: {{ new Date(reservation.checkin).toLocaleDateString('pt-br') }}</p>
          <p id="detailsCheckout">Check in: {{ new Date(reservation.checkout).toLocaleDateString('pt-br') }}</p>
