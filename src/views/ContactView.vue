    ...
    <div class="main">
      ...
      <article class="main__login">
        <form action="/public" method="get">
          ...
          <input type="email" placeholder="Digite seu melhor email" id="email" name="email" required>

          <label for="phone">Telefone:</label>
          <input type="tel" placeholder="Digite seu telefone" id="phone" name="phone" required>
