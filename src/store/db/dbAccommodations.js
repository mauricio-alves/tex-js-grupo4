const dbAccommodations = [
  {
    id: 0,
    image: "/src/assets/images/QuartoCasal.png",
    accommodation: "Quarto Casal",
    idLabel: "casal",
    description:
      "Nossa opção para você que busca um espaço mais intimista. Com design em madeira e vidro, destacando a luz natural, possui vista para o mar. Perfeito para um final de semana com quem você ama!",
    price: 190,
  },
  {
    id: 1,
    image: "/src/assets/images/SuítePresidencial.jpg",
    accommodation: "Quarto Executivo",
    idLabel: "executiva",
    description:
      "Para você que busca conforto e mais espaço, a suíte executiva é a ideal. Além do design em madeira, possui paredes de vidro que permitem você acordar todas as manhãs com uma vista sensacional.",
    price: 350,
  },
  {
    id: 2,
    image: "/src/assets/images/quarto_hotel.jpg",
    accommodation: "Quarto Presidencial Luxo",
    idLabel: "presidencial",
    description:
      "Nossa principal acomodação, a suíte presidencial luxo possui 1.132 metros quadrados, design intimista com cores sóbrias e duas suítes com banheira de hidromassagem para a sua inteira disposição. Não deixe de conferir!",
    price: 600,
  },
  {
    id: 3,
    image: "/src/assets/images/QuartoLuxo.jpg",
  ...
  {
    id: 4,
    image: "/src/assets/images/suite-estudio-3.jpg",
  ...
  {
    id: 5,
    image: "/src/assets/images/suite-executiva-4.jpg",
  ...
  {
    id: 6,
    image: "/src/assets/images/1604663246841.jpg",
  ...
  {
    id: 7,
    image: "/src/assets/images/suite-presidencial-1.jpg",
